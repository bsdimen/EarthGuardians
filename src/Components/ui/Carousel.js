            ...
            <div className='Slides'>
            {
                ...
                filteredSlides.map((slide) => (
                        <div key={slide.id} className="slide">
                            <div className={`slide-image ${slide.imgClass} ${slide.id === currentSlide ? 'active' : ''}`}>
                            {/* Image content is handled by CSS */}
                            ...
                            <div className={`slide-content ${slide.id} ${slide.id === currentSlide ? 'active' : ''}`}>
                                {slide.heroContent}
                            </div>
